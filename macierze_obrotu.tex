...
oraz macierzy obrotu wektora w tym układzie.
\end{abstract}
...
Obrót wersorów $i$ oraz $j$ o kąt $\alpha$ przeciwnie do ruchu wskazówek zegara
...
\end{equation}
Powyższe dwa równania możemy zapisać przy użyciu {\em macierzy obrotu\/} o kąt $\alpha$
przeciwnie do ruchu wskazówek zegara jako
\begin{equation}
\begin{bmatrix}
i' \\ 
j' 
...
przeciwnie do ruchu wskazówek zegara to otrzymamy wersory $i''$ oraz $j''$
\begin{equation}
\begin{bmatrix}
i'' \\ 
j'' 
...
Obracamy układ współrzędnych $Oxy$ o kąt $\alpha$ przeciwnie do ruchu wskazówek zegara otrzymując
...
Składając obrót wersorów $i$ oraz $j$ o kąt $\alpha$ z obrotem o kąt $\beta$ przeciwnie do ruchu wskazówek zegara otrzymujemy macierz obrotu tych wersorów o kąt $\alpha + \beta$\@.
...
\begin{equation}
\vec{r} = x \, i + y \, j = r \cos \theta \, i + r \sin \theta \, j = r x \, i + r y \, j
\end{equation}
Obracając ten wektor $\vec{r}$ o kąt $\alpha$ przeciwnie do ruchu wskazówek zegara
...
\end{eqnarray}
Z powyższego otrzymujemy, że współrzędne $x'$ oraz $y'$ wektora $\vec{r}$ obróconego o kąt $\alpha$ przeciwnie 
do ruchu wskazówek zegara wynoszą
\begin{eqnarray}
...
wokół osi $Oz$
przeciwnie do kierunku ruchu wskazówek zegara to musielibyśmy złożyć dwa obroty co odpowiada w macierzowym zapisie
\begin{equation}
\begin{bmatrix}
x'' \\ 
y'' 
