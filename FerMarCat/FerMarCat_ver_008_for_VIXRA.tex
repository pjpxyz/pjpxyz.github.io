...
We can write the Fermat's Diophantine equation %\cite{Edwards1978FLT, Vandiver1929FLT, Vandiver1946FLT, Dickson1917FLT} 
as
\begin{equation}
\label{eq:FDE}
a^{n} + b^{n} = c^{n},
...
We write the Markov Diophantine equation %\cite{Markov1879, Frobenius1913, Gyoda2022} 
as
\begin{equation}
...
% \bibliography{FerMarCat_IJDANT_ver_008_for_VIXRA.bib}

\begin{thebibliography}{9}


\bibitem{Diophantine_equation} Wikipedia.org {\em Diophantine equation\/} 
                                    (2026) and the References cited therein
